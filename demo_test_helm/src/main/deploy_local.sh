...
helm upgrade --debug --force --wait-for-jobs --atomic --install demo_kafka  test_kafka  --timeout 15m  --set serviceType=LoadBalancer --version ${VERSION} --namespace=${NAMESPACE}
